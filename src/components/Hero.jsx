...
export default function Hero() {
  ...
  return (
    <div
      className="hero h-5/6 w-full bg-cover bg-no-repeat bg-left-top flex items-center justify-center"
    ...
    >
      <div className="hero__content w-fit m-auto text-center">
        ...
        <p className="m-auto w-9/12 md:w-[500px] text-white text-left mb-10">
